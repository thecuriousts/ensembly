...
const RULES = [
  ...
  { re: /\b(board|quests?)\b/i, action: { type: 'TOGGLE_BOARD' } },
  { re: /\b(bars?|telemetry|hud bars)\b/i, action: { type: 'TOGGLE_BARS' } },
  { re: /\b(menu|command)\b/i, action: { type: 'TOGGLE_MENU' } },
  { re: /\b(help|commands)\b/i, action: { type: 'TOGGLE_HELP' } },
  { re: /\b(close|clear ui|hide)\b/i, action: { type: 'CLOSE_CHROME' } },
