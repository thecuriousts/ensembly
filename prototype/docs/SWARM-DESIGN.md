...
The product is the **control plane + turn + Game of Peram + production remote bridge** — production life infrastructure ([PRODUCT-CHARTER.md](PRODUCT-CHARTER.md), [AGENTS.md](../AGENTS.md)), not a hobby demo.
